...
module UntisTimetableClient
  class FilterResourceTypeEnum
    ...
    def self.all_vars
      @all_vars ||= [CLASS, ROOM, STUDENT, TEACHER, LESSON, PERIOD].freeze
    end
    ...
    def build_from_hash(value)
      return value if FilterResourceTypeEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FilterResourceTypeEnum"
    end
  end
end
