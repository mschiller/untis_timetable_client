...
module UntisTimetableClient
  # A timegrid.
  class TimeGridDto
    # WebUntis Timegrid Id.
    attr_accessor :id

    # Time slots for regular periods for each day of the week.
    attr_accessor :time_grid_slots

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'id' => :'id',
        :'time_grid_slots' => :'timeGridSlots'
      }
    end
    ...
    def self.openapi_types
      {
        :'id' => :'Integer',
        :'time_grid_slots' => :'Array<TimeGridSlotDto>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UntisTimetableClient::TimeGridDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UntisTimetableClient::TimeGridDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'time_grid_slots')
        if (value = attributes[:'time_grid_slots']).is_a?(Array)
          self.time_grid_slots = value
        end
      else
        self.time_grid_slots = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @time_grid_slots.nil?
        invalid_properties.push('invalid value for "time_grid_slots", time_grid_slots cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @time_grid_slots.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] time_grid_slots Value to be assigned
    def time_grid_slots=(time_grid_slots)
      if time_grid_slots.nil?
        fail ArgumentError, 'time_grid_slots cannot be nil'
      end

      @time_grid_slots = time_grid_slots
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          time_grid_slots == o.time_grid_slots
    end
