...
module UntisTimetableClient
  class PeriodStatusEnum
    ...
    def self.all_vars
      @all_vars ||= [REGULAR, CANCELLED, ADDITIONAL, CHANGED].freeze
    end
    ...
    def build_from_hash(value)
      return value if PeriodStatusEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PeriodStatusEnum"
    end
  end
end
