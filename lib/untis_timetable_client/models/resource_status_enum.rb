...
module UntisTimetableClient
  class ResourceStatusEnum
    REGULAR = "REGULAR".freeze
    ADDED = "ADDED".freeze
    REMOVED = "REMOVED".freeze

    def self.all_vars
      @all_vars ||= [REGULAR, ADDED, REMOVED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ResourceStatusEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ResourceStatusEnum"
    end
  end
end
