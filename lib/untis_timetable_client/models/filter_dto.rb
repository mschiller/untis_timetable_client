...
module UntisTimetableClient
  # Filter criterias. These are taken from the request.
  class FilterDto
    # Start of timetable periods.
    attr_accessor :start

    # End of timetable periods.
    attr_accessor :_end

    # Pagination size. No limit = 0. Limit the number of periods that are returned, starting with the earliest period. Can be used to get the next N periods.
    attr_accessor :limit

    # Pagination offset. Skip the first N results. First result = 1. No pagination = 0.
    attr_accessor :offset

    attr_accessor :filter_by_changes

    attr_accessor :filter_by_resource
    ...
    def self.attribute_map
      {
        ...
        :'limit' => :'limit',
        :'offset' => :'offset',
        :'filter_by_changes' => :'filterByChanges',
        :'filter_by_resource' => :'filterByResource'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'limit' => :'Integer',
        :'offset' => :'Integer',
        :'filter_by_changes' => :'FilterByChangesDto',
        :'filter_by_resource' => :'Array<FilterByResourceDto>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UntisTimetableClient::FilterDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UntisTimetableClient::FilterDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'filter_by_changes')
        self.filter_by_changes = attributes[:'filter_by_changes']
      end

      if attributes.key?(:'filter_by_resource')
        if (value = attributes[:'filter_by_resource']).is_a?(Array)
          self.filter_by_resource = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          limit == o.limit &&
          offset == o.offset &&
          filter_by_changes == o.filter_by_changes &&
          filter_by_resource == o.filter_by_resource
    end
    ...
    def hash
      [start, _end, limit, offset, filter_by_changes, filter_by_resource].hash
    end
