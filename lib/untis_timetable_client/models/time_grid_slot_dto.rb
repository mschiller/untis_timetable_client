...
module UntisTimetableClient
  # A timegrid slot.
  class TimeGridSlotDto
    # Weekday. 1=Monday, 7=Sunday
    attr_accessor :day

    # Incremental number of the timegrid slot per day.
    attr_accessor :unit_of_day
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UntisTimetableClient::TimeGridSlotDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UntisTimetableClient::TimeGridSlotDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unit_of_day')
        self.unit_of_day = attributes[:'unit_of_day']
      end
    ...
    def list_invalid_properties
      ...
      if @day > 7
        invalid_properties.push('invalid value for "day", must be smaller than or equal to 7.')
      end
      ...
      if !@unit_of_day.nil? && @unit_of_day < 0
        invalid_properties.push('invalid value for "unit_of_day", must be greater than or equal to 0.')
      end
      ...
      if @start > 2400
        invalid_properties.push('invalid value for "start", must be smaller than or equal to 2400.')
      end
      ...
      if @_end > 2400
        invalid_properties.push('invalid value for "_end", must be smaller than or equal to 2400.')
      end
    ...
    def valid?
      ...
      return false if !@unit_of_day.nil? && @unit_of_day < 0
      return false if @start.nil?
      return false if @start > 2400
      return false if @start < 0
      return false if @_end.nil?
      return false if @_end > 2400
    ...
    # Custom attribute writer method with validation
    # @param [Object] unit_of_day Value to be assigned
    def unit_of_day=(unit_of_day)
      if unit_of_day.nil?
        fail ArgumentError, 'unit_of_day cannot be nil'
      end

      if unit_of_day < 0
        fail ArgumentError, 'invalid value for "unit_of_day", must be greater than or equal to 0.'
      end

      @unit_of_day = unit_of_day
    end
    ...
    def start=(start)
      ...
      if start > 2400
        fail ArgumentError, 'invalid value for "start", must be smaller than or equal to 2400.'
      end
    ...
    def _end=(_end)
      ...
      if _end > 2400
        fail ArgumentError, 'invalid value for "_end", must be smaller than or equal to 2400.'
      end
    ...
    def hash
      [day, unit_of_day, start, _end, name].hash
    end
