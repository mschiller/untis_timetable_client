...
# Unit tests for UntisTimetableClient::SubjectDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::SubjectDto do
  let(:instance) { UntisTimetableClient::SubjectDto.new }

  describe 'test an instance of SubjectDto' do
    it 'should create an instance of SubjectDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::SubjectDto)
    end
  end
