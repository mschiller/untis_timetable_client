...
# Unit tests for UntisTimetableClient::ValidationErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::ValidationErrorResponse do
  let(:instance) { UntisTimetableClient::ValidationErrorResponse.new }
  ...
  describe 'test an instance of ValidationErrorResponse' do
    it 'should create an instance of ValidationErrorResponse' do
      ...
      #expect(instance).to be_instance_of(UntisTimetableClient::ValidationErrorResponse)
    end
  end
