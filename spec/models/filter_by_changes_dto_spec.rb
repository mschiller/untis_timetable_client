...
# Unit tests for UntisTimetableClient::FilterByChangesDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::FilterByChangesDto do
  let(:instance) { UntisTimetableClient::FilterByChangesDto.new }

  describe 'test an instance of FilterByChangesDto' do
    it 'should create an instance of FilterByChangesDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::FilterByChangesDto)
    end
  end

  describe 'test attribute "date_last_modified_after"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "date_last_modified_until"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
