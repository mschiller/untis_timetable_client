...
# Unit tests for UntisTimetableClient::RoomDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::RoomDto do
  let(:instance) { UntisTimetableClient::RoomDto.new }

  describe 'test an instance of RoomDto' do
    it 'should create an instance of RoomDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::RoomDto)
    end
  end
