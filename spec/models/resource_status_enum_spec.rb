...
# Unit tests for UntisTimetableClient::ResourceStatusEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::ResourceStatusEnum do
  let(:instance) { UntisTimetableClient::ResourceStatusEnum.new }

  describe 'test an instance of ResourceStatusEnum' do
    it 'should create an instance of ResourceStatusEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::ResourceStatusEnum)
    end
  end
