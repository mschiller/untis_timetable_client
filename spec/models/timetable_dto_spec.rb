...
# Unit tests for UntisTimetableClient::TimetableDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::TimetableDto do
  let(:instance) { UntisTimetableClient::TimetableDto.new }

  describe 'test an instance of TimetableDto' do
    it 'should create an instance of TimetableDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::TimetableDto)
    end
  end
  ...
  describe 'test attribute "header_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "timetable_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
