...
# Unit tests for UntisTimetableClient::PeriodResourceDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::PeriodResourceDto do
  let(:instance) { UntisTimetableClient::PeriodResourceDto.new }

  describe 'test an instance of PeriodResourceDto' do
    it 'should create an instance of PeriodResourceDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::PeriodResourceDto)
    end
  end
