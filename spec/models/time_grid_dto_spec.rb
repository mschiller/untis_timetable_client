...
# Unit tests for UntisTimetableClient::TimeGridDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::TimeGridDto do
  let(:instance) { UntisTimetableClient::TimeGridDto.new }

  describe 'test an instance of TimeGridDto' do
    it 'should create an instance of TimeGridDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::TimeGridDto)
    end
  end
  ...
  describe 'test attribute "time_grid_slots"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
