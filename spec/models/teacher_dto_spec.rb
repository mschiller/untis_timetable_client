...
# Unit tests for UntisTimetableClient::TeacherDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::TeacherDto do
  let(:instance) { UntisTimetableClient::TeacherDto.new }

  describe 'test an instance of TeacherDto' do
    it 'should create an instance of TeacherDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::TeacherDto)
    end
  end
