...
# Unit tests for UntisTimetableClient::PeriodIconEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::PeriodIconEnum do
  let(:instance) { UntisTimetableClient::PeriodIconEnum.new }

  describe 'test an instance of PeriodIconEnum' do
    it 'should create an instance of PeriodIconEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::PeriodIconEnum)
    end
  end
