...
# Unit tests for UntisTimetableClient::ResourceRefDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::ResourceRefDto do
  let(:instance) { UntisTimetableClient::ResourceRefDto.new }

  describe 'test an instance of ResourceRefDto' do
    it 'should create an instance of ResourceRefDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::ResourceRefDto)
    end
  end
