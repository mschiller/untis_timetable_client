...
# Unit tests for UntisTimetableClient::MasterDataDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::MasterDataDto do
  let(:instance) { UntisTimetableClient::MasterDataDto.new }

  describe 'test an instance of MasterDataDto' do
    it 'should create an instance of MasterDataDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::MasterDataDto)
    end
  end
  ...
  describe 'test attribute "student_groups"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
