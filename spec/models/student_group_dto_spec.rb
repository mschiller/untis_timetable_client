...
# Unit tests for UntisTimetableClient::StudentGroupDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::StudentGroupDto do
  let(:instance) { UntisTimetableClient::StudentGroupDto.new }

  describe 'test an instance of StudentGroupDto' do
    it 'should create an instance of StudentGroupDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::StudentGroupDto)
    end
  end
