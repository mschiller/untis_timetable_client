...
# Unit tests for UntisTimetableClient::ClassDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::ClassDto do
  let(:instance) { UntisTimetableClient::ClassDto.new }

  describe 'test an instance of ClassDto' do
    it 'should create an instance of ClassDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::ClassDto)
    end
  end
