...
# Unit tests for UntisTimetableClient::HeaderDataDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::HeaderDataDto do
  let(:instance) { UntisTimetableClient::HeaderDataDto.new }

  describe 'test an instance of HeaderDataDto' do
    it 'should create an instance of HeaderDataDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::HeaderDataDto)
    end
  end
  ...
  describe 'test attribute "school_year_start"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "school_year_end"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
