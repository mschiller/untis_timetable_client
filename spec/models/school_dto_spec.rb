...
# Unit tests for UntisTimetableClient::SchoolDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::SchoolDto do
  let(:instance) { UntisTimetableClient::SchoolDto.new }

  describe 'test an instance of SchoolDto' do
    it 'should create an instance of SchoolDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::SchoolDto)
    end
  end
