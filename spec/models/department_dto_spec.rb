...
# Unit tests for UntisTimetableClient::DepartmentDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::DepartmentDto do
  let(:instance) { UntisTimetableClient::DepartmentDto.new }

  describe 'test an instance of DepartmentDto' do
    it 'should create an instance of DepartmentDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::DepartmentDto)
    end
  end
