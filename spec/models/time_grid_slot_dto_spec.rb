...
# Unit tests for UntisTimetableClient::TimeGridSlotDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::TimeGridSlotDto do
  let(:instance) { UntisTimetableClient::TimeGridSlotDto.new }

  describe 'test an instance of TimeGridSlotDto' do
    it 'should create an instance of TimeGridSlotDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::TimeGridSlotDto)
    end
  end
  ...
  describe 'test attribute "unit_of_day"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
