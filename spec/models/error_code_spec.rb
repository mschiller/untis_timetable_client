...
# Unit tests for UntisTimetableClient::ErrorCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::ErrorCode do
  let(:instance) { UntisTimetableClient::ErrorCode.new }

  describe 'test an instance of ErrorCode' do
    it 'should create an instance of ErrorCode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::ErrorCode)
    end
  end
