...
# Unit tests for UntisTimetableClient::ErrorData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::ErrorData do
  let(:instance) { UntisTimetableClient::ErrorData.new }

  describe 'test an instance of ErrorData' do
    it 'should create an instance of ErrorData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::ErrorData)
    end
  end
