...
# Unit tests for UntisTimetableClient::TimetableDataDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::TimetableDataDto do
  let(:instance) { UntisTimetableClient::TimetableDataDto.new }

  describe 'test an instance of TimetableDataDto' do
    it 'should create an instance of TimetableDataDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::TimetableDataDto)
    end
  end

  describe 'test attribute "time_grids"' do
    it 'should work' do
