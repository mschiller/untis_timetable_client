...
# Unit tests for UntisTimetableClient::FilterResourceTypeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::FilterResourceTypeEnum do
  let(:instance) { UntisTimetableClient::FilterResourceTypeEnum.new }

  describe 'test an instance of FilterResourceTypeEnum' do
    it 'should create an instance of FilterResourceTypeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::FilterResourceTypeEnum)
    end
  end
