...
# Unit tests for UntisTimetableClient::MasterDataObjectDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::MasterDataObjectDto do
  let(:instance) { UntisTimetableClient::MasterDataObjectDto.new }

  describe 'test an instance of MasterDataObjectDto' do
    it 'should create an instance of MasterDataObjectDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::MasterDataObjectDto)
    end
  end
