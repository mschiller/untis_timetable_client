...
# Unit tests for UntisTimetableClient::FilterByResourceDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::FilterByResourceDto do
  let(:instance) { UntisTimetableClient::FilterByResourceDto.new }

  describe 'test an instance of FilterByResourceDto' do
    it 'should create an instance of FilterByResourceDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::FilterByResourceDto)
    end
  end
