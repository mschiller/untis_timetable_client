...
# Unit tests for UntisTimetableClient::FilterDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::FilterDto do
  let(:instance) { UntisTimetableClient::FilterDto.new }

  describe 'test an instance of FilterDto' do
    it 'should create an instance of FilterDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::FilterDto)
    end
  end
  ...
  describe 'test attribute "filter_by_changes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "filter_by_resource"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
