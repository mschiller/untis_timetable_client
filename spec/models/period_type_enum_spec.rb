...
# Unit tests for UntisTimetableClient::PeriodTypeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::PeriodTypeEnum do
  let(:instance) { UntisTimetableClient::PeriodTypeEnum.new }

  describe 'test an instance of PeriodTypeEnum' do
    it 'should create an instance of PeriodTypeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::PeriodTypeEnum)
    end
  end
