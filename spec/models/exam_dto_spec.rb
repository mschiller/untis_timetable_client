...
# Unit tests for UntisTimetableClient::ExamDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe UntisTimetableClient::ExamDto do
  let(:instance) { UntisTimetableClient::ExamDto.new }

  describe 'test an instance of ExamDto' do
    it 'should create an instance of ExamDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(UntisTimetableClient::ExamDto)
    end
  end
